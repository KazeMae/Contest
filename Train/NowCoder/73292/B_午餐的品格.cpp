...
| Problem: B_午餐的品格
| Contest: NowCoder
| URL:     https://ac.nowcoder.com/acm/contest/73292/B
| When:    2024-01-05 13:11:59
|
| Memory:  524288 MB
| Time:    2000 ms
*******************************/
...
int C(int a, int b, int p = MOD)  // 通过定理求组合数C(a, b)
{
    if (a < b) return 0;
    ...
    return x * (long long)qmi(y, p - 2) % p;
}
